#ifndef TsIRTContinuous_hh
#define TsIRTContinuous_hh
...
class TsIRTContinuous: public TsVIRTProcedure {
public:
	TsIRTContinuous(TsParameterManager*, G4String);
	~TsIRTContinuous();
	...
	void AddMolecule(TsIRTConfiguration::TsMolecule, G4int);
...
//	std::vector<TsIRTConfiguration::TsMolecule> fChemicalSpecies;
	...
	std::unordered_map<G4int,std::vector<TsIRTConfiguration::TsMolecule>> fPulseMoleculeMap;
